...
Add LoadPath "/Users/zeinamigeed/Software foundations/lf".
...
match l1, l2 with 
| nil, nil => nil
| h :: t, h' :: t' =>  (cons h (cons h' (alternate t t')))
| nil, h' :: t' =>  l2
| h :: t, nil =>  l1
end.
...
match s1, s2 with
| nil, nil => true
| h :: t , h' :: t' => (subset (remove_one h' s1)  t')
| nil , h' :: t' => true
| h :: t, nil =>  false
end.
...
simpl. reflexivity.
simpl. rewrite -> rev_app_distr. rewrite -> IHl1'. simpl. 
reflexivity. Qed.
...
Proof.
intros s. induction s as [|s IHs'].
simpl. reflexivity.
destruct s as [| s']. rewrite -> ble_n_Sn. reflexivity.
simpl. rewrite -> IHIHs'. reflexivity. Qed.
